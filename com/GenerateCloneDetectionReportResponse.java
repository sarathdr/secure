 ...
 *       &lt;sequence&gt;
 *         &lt;element name="cloneSuspects" type="{urn:com.flexnet.lfs.webservice}cloneSuspect" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
    ...
    extends BaseResponse
{
    ...
    protected List<CloneSuspect> cloneSuspects;
     ...
     * This is why there is not a <CODE>set</CODE> method for the cloneSuspects property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCloneSuspects().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<CloneSuspect> getCloneSuspects() {
        if (cloneSuspects == null) {
            cloneSuspects = new ArrayList<CloneSuspect>();
        }
